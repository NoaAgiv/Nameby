...
//    public static NameList untaggedNames;
...
//    private static Name END_OF_LIST = new Name("Congrats! You tagged all the untaggedNames!","f", 0);
...
//    }
//
//    public static ImageView getDisloveButton() {
//        return disloveImage;
//    }
//
...
//        Log.e("azdsadsaamnk.cassd", Integer.toString(untaggedNames.size()));
//        lovedNames = databaseAccess.getLovedNames(user);
//        unlovedNames = databaseAccess.getUnlovedNames(user);
//        databaseAccess.close();
//        partnerlovedNames = getPartnerLovedNames();
...
//        updateMatchedNames();
//
//        untaggedNamesView = new NameTaggerViewContainer((TextView) activity.findViewById(R.id.untagged_names_view));
//        untaggedNamesView.setName(getNextUntaggedName());
